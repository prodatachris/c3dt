...
import { Check, ArrowRight, Zap, Cpu, Box, Settings, Globe, Shield, Activity, Gauge, HardDrive, Thermometer, Wrench, FileText, Download, DollarSign, Clock, Layers, TrendingUp, Grid3x3, Workflow } from 'lucide-react';
...
export default function EVO() {
  ...
  return (
    <div className="pt-20 bg-black min-h-screen">
      ...
      <section className="py-24 bg-gradient-to-b from-gray-950 via-black to-black relative overflow-hidden">
        <div className="absolute inset-0 bg-grid-white/[0.02] bg-[size:60px_60px]" />
